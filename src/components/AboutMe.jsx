...
function AboutMe() {
  const aboutMe = [
    "I am Amit Samadder, a front-end developer based in Bangladesh with a B.Sc. in Software Engineering from Daffodil International University. I build responsive, production-friendly interfaces with a strong eye for layout, consistency, and real user workflows.",
    "My day-to-day toolkit includes HTML, CSS, JavaScript, React, Next.js, TypeScript, and Tailwind CSS. I enjoy turning Figma designs into clean component systems that are easy to maintain and comfortable across devices.",
